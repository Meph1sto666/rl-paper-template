...
\newdateformat{defaultdate}{\THEDAY\ \monthname[\THEMONTH] \THEYEAR}
...
\title{Rhine Lab themed paper template \\\large all content(text) copied from fandom}
...
\fancyhead[R]{%
    \defaultdate{\today}\\
    \defaultdate{\formatdate{23}{4}{1083}}% << leave that % here
}
\fancyhead[L]{\includegraphics[width=15mm]{images/rl_logo_inverted.png}}
\fancyfoot[C]{\thepage}
%% header/footer end

\author{ % authors extracolsep if few authors or should not look too centered
    \begin{tabular}[t]{c c c c c} % @{\extracolsep{15em}} 
        Olivia Silence & Muelsyse & Dr. Elna Urbica & Nasti Lundrey & Dorothy Franks \\
        % Rhine Lab & Rhine Lab & ---\\
        STRU & ECO & NRG & ENG & ORIG \\ 
    \end{tabular}
}
